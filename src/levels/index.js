  ...
  // ---------------------------------------------------------------- 2
  {
    ...
    objectives: [
      ...
      { type: 'reach', zone: [-11.2, -41.6, 3], text: 'ESTABLISH OBSERVATION POST ALPHA' },
      {
        ...
        yaw: Math.PI,
        persistIntel: true,
        result: 'THREE ASSAULT LANES MAPPED — FIRE MISSION TRANSMITTED',
        targets: [
        ...
        groundResponses: [
          {
            ...
            baseCount: 3,
            enemies: [
              { pos: [9, 0, 34], patrol: [[9, 34], [7, 14], [4, -10]] },
              { pos: [6, 0, 30], patrol: [[6, 30], [8, 12], [3, -12]] },
              { pos: [11, 0, 25], patrol: [[11, 25], [7, 8], [2, -14]] },
              { pos: [4, 0, 37], patrol: [[4, 37], [6, 18], [0, -8]] },
            ],
          },
          {
            lane: 'CENTRAL',
            label: 'EAST/WEST LANES CUT — CENTRAL FIRETEAM THROUGH',
            baseCount: 3,
            enemies: [
              { pos: [1, 0, 36], patrol: [[1, 36], [0, 15], [0, -11]] },
              { pos: [-3, 0, 31], patrol: [[-3, 31], [-1, 12], [1, -13]] },
              { pos: [4, 0, 27], patrol: [[4, 27], [2, 8], [0, -15]] },
              { pos: [-6, 0, 38], patrol: [[-6, 38], [-3, 18], [0, -9]] },
            ],
          },
          {
            lane: 'WEST',
            label: 'EAST/CENTRAL LANES CUT — WEST ASSAULT TEAM THROUGH',
            baseCount: 3,
            enemies: [
              { pos: [-9, 0, 35], patrol: [[-9, 35], [-8, 16], [-4, -10]] },
              { pos: [-6, 0, 30], patrol: [[-6, 30], [-9, 11], [-3, -13]] },
              { pos: [-11, 0, 25], patrol: [[-11, 25], [-7, 7], [-2, -15]] },
              { pos: [-4, 0, 38], patrol: [[-4, 38], [-6, 18], [0, -8]] },
            ],
          },
        ],
      },
      { type: 'clear', zone: null, text: 'INTERCEPT THE SURVIVING ASSAULT ELEMENT' },
